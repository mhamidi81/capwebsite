...
class UploadComponent extends Component {
	 ...
	 * @return UploadComponent
	 */
	public function custom_name($int_name) {
		
		//enlever les caracters specieux du nom de fichier 
		$name = preg_replace("/[^a-zA-Z0-9_]/", "",pathinfo($int_name, PATHINFO_FILENAME));
		//recupperer l'extension du fichier

		$ext = pathinfo($int_name, PATHINFO_EXTENSION);
		
		//Ajouter le timestamp de la date de création en préf
		$fielname =  $name.'_'.time().'.'.$ext;
