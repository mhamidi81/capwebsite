<?php
App::uses('CounselorsLanguagesController', 'ProfileManagment.Controller');

/**
 * CounselorsLanguagesController Test Case
 *
 */
class CounselorsLanguagesControllerTest extends ControllerTestCase {
