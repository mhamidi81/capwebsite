<?php
App::uses('PublicationResearchsController', 'ProfileManagment.Controller');

/**
 * PublicationResearchsController Test Case
 *
 */
class PublicationResearchsControllerTest extends ControllerTestCase {
