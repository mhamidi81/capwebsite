<?php
App::uses('ProfessionalExperiencesController', 'ProfileManagment.Controller');

/**
 * ProfessionalExperiencesController Test Case
 *
 */
class ProfessionalExperiencesControllerTest extends ControllerTestCase {
