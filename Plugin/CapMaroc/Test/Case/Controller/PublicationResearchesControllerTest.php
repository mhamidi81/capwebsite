<?php
App::uses('PublicationResearchesController', 'ProfileManagment.Controller');

/**
 * PublicationResearchesController Test Case
 *
 */
class PublicationResearchesControllerTest extends ControllerTestCase {
