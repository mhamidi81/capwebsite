<?php
App::uses('DiplomeTypesController', 'ProfileManagment.Controller');

/**
 * DiplomeTypesController Test Case
 *
 */
class DiplomeTypesControllerTest extends ControllerTestCase {
