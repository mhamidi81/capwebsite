<?php
App::uses('CounselorsSpecialitiesController', 'ProfileManagment.Controller');

/**
 * CounselorsSpecialitiesController Test Case
 *
 */
class CounselorsSpecialitiesControllerTest extends ControllerTestCase {
