<?php
App::uses('CommunityActivitiesController', 'ProfileManagment.Controller');

/**
 * CommunityActivitiesController Test Case
 *
 */
class CommunityActivitiesControllerTest extends ControllerTestCase {
