...
--
-- Client: localhost
-- Généré le: Jeu 09 Juillet 2015 à 22:32
...
--
-- Base de données: `manarsys_deferv2`
--
...
CREATE TABLE IF NOT EXISTS `web_acos` (
...
CREATE TABLE IF NOT EXISTS `web_aros` (
  `id` int(10) NOT NULL AUTO_INCREMENT,
  `parent_id` int(10) DEFAULT NULL,
  `model` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
  `foreign_key` int(10) DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `web_aros_acos` (
  `id` int(10) NOT NULL AUTO_INCREMENT,
...
--
-- Contenu de la table `web_meta`
--

INSERT INTO `web_meta` (`id`, `model`, `foreign_key`, `key`, `value`, `weight`, `created`, `created_by`, `updated`, `updated_by`) VALUES
(1, 'Node', 1, 'meta_keywords', 'key1, key2', NULL, '2015-07-07 02:14:01', NULL, '2015-07-07 02:14:01', NULL);
...
CREATE TABLE IF NOT EXISTS `web_model_taxonomies` (
  `id` int(20) NOT NULL AUTO_INCREMENT,
  `model` varchar(50) COLLATE utf8_unicode_ci NOT NULL DEFAULT 'Node',
...
INSERT INTO `web_nodes` (`id`, `parent_id`, `user_id`, `title`, `slug`, `body`, `excerpt`, `status`, `mime_type`, `comment_status`, `comment_count`, `promote`, `path`, `terms`, `sticky`, `lft`, `rght`, `visibility_roles`, `type`, `publish_start`, `publish_end`, `updated`, `updated_by`, `created`, `created_by`) VALUES
...
CREATE TABLE IF NOT EXISTS `web_regions` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `title` varchar(100) COLLATE utf8_unicode_ci NOT NULL,
...
(4, 'right', 'right', '', 6, '2015-07-07 02:14:01', NULL, '2015-07-07 02:14:01', NULL),
(6, 'left', 'left', '', 0, '2015-07-07 02:14:01', NULL, '2015-07-07 02:14:01', NULL),
(7, 'header', 'header', '', 0, '2015-07-07 02:14:01', NULL, '2015-07-07 02:14:01', NULL),
(8, 'footer', 'footer', '', 0, '2015-07-07 02:14:01', NULL, '2015-07-07 02:14:01', NULL),
(9, 'region1', 'region1', '', 0, '2015-07-07 02:14:01', NULL, '2015-07-07 02:14:01', NULL),
(10, 'region2', 'region2', '', 0, '2015-07-07 02:14:01', NULL, '2015-07-07 02:14:01', NULL),
(11, 'region3', 'region3', '', 0, '2015-07-07 02:14:01', NULL, '2015-07-07 02:14:01', NULL),
(12, 'region4', 'region4', '', 0, '2015-07-07 02:14:01', NULL, '2015-07-07 02:14:01', NULL),
(13, 'region5', 'region5', '', 0, '2015-07-07 02:14:01', NULL, '2015-07-07 02:14:01', NULL),
(14, 'region6', 'region6', '', 0, '2015-07-07 02:14:01', NULL, '2015-07-07 02:14:01', NULL),
(15, 'region7', 'region7', '', 0, '2015-07-07 02:14:01', NULL, '2015-07-07 02:14:01', NULL),
(16, 'region8', 'region8', '', 0, '2015-07-07 02:14:01', NULL, '2015-07-07 02:14:01', NULL),
...
CREATE TABLE IF NOT EXISTS `web_roles_users` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
(6, 'Site.title', 'Ministère de l’Agriculture et de la Pêche maritime', '', '', '', 1, 1, '', '2015-07-07 02:14:01', NULL, '2015-07-08 22:57:13', 1),
(7, 'Site.tagline', 'Ministère de l’Agriculture et de la Pêche maritime, devenir conseiller agricole agrée', '', '', 'textarea', 1, 2, '', '2015-07-07 02:14:01', NULL, '2015-07-08 22:57:14', 1),
(8, 'Site.email', 'you@your-site.com', '', '', '', 1, 3, '', '2015-07-07 02:14:01', NULL, '2015-07-08 22:57:14', 1),
(9, 'Site.status', '1', '', '', 'checkbox', 1, 6, '', '2015-07-07 02:14:01', NULL, '2015-07-08 22:57:14', 1),
...
(20, 'Site.theme', 'Defer', '', '', '', 0, 14, '', '2015-07-07 02:14:01', NULL, '2015-07-07 02:14:01', 1),
(21, 'Site.feed_url', '', '', '', '', 0, 15, '', '2015-07-07 02:14:01', NULL, '2015-07-07 02:14:01', NULL),
(22, 'Reading.nodes_per_page', '5', '', '', '', 1, 16, '', '2015-07-07 02:14:01', NULL, '2015-07-07 02:14:01', NULL),
(23, 'Writing.wysiwyg', '1', 'Enable WYSIWYG editor', '', 'checkbox', 1, 17, '', '2015-07-07 02:14:01', NULL, '2015-07-07 02:14:01', NULL),
(24, 'Comment.level', '1', '', 'levels deep (threaded comments)', '', 1, 18, '', '2015-07-07 02:14:01', NULL, '2015-07-07 02:14:01', NULL),
(25, 'Comment.feed_limit', '10', '', 'number of comments to show in feed', '', 1, 19, '', '2015-07-07 02:14:01', NULL, '2015-07-07 02:14:01', NULL),
(26, 'Site.locale', 'fra', '', '', 'text', 1, 20, '', '2015-07-07 02:14:01', NULL, '2015-07-08 22:57:14', 1),
(27, 'Reading.date_time_format', 'D, M d Y H:i:s', '', '', '', 1, 21, '', '2015-07-07 02:14:01', NULL, '2015-07-07 02:14:01', NULL),
(28, 'Comment.date_time_format', 'M d, Y', '', '', '', 1, 22, '', '2015-07-07 02:14:01', NULL, '2015-07-07 02:14:01', NULL),
(29, 'Site.timezone', 'UTC', '', 'Provide a valid timezone identifier as specified in https://php.net/manual/en/timezones.php', '', 1, 4, '', '2015-07-07 02:14:01', NULL, '2015-07-08 22:57:14', 1),
(32, 'Hook.bootstraps', 'Settings,Comments,Contacts,Nodes,Meta,Menus,Users,Blocks,Taxonomy,FileManager,Wysiwyg,Ckeditor', '', '', '', 0, 23, '', '2015-07-07 02:14:01', NULL, '2015-07-07 02:14:01', NULL),
(33, 'Comment.email_notification', '1', 'Enable email notification', '', 'checkbox', 1, 24, '', '2015-07-07 02:14:01', NULL, '2015-07-07 02:14:01', NULL),
...
(38, 'Site.ipWhitelist', '127.0.0.1', 'Whitelisted IP Addresses', 'Separate multiple IP addresses with comma', 'text', 1, 27, '', '2015-07-07 02:14:01', NULL, '2015-07-08 22:57:14', 1),
...
(40, 'Site.admin_theme', '', 'Administration Theme', '', 'text', 1, 29, '', '2015-07-07 02:14:01', NULL, '2015-07-08 22:57:14', 1),
(41, 'Site.home_url', '', 'Home Url', 'Default action for home page in link string format.', 'text', 1, 30, '', '2015-07-07 02:14:01', NULL, '2015-07-08 22:57:14', 1),
...
(44, 'Site.direction', 'ltr', 'Orientation du site (LTR ou RTL)', '', 'radio', 1, 33, 'options={"rtl": "RTL", "ltr": "LTR"}', '2015-07-07 03:14:49', 1, '2015-07-08 22:57:14', 1),
(45, 'Site.is_responsive', '1', 'Responsive design', '', 'checkbox', 1, 34, '', '2015-07-07 03:51:07', 1, '2015-07-08 22:57:14', 1);
...
CREATE TABLE IF NOT EXISTS `web_taxonomies` (
  `id` int(20) NOT NULL AUTO_INCREMENT,
  `parent_id` int(20) DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `web_types_vocabularies` (
  `id` int(10) NOT NULL AUTO_INCREMENT,
...
INSERT INTO `web_users` (`id`, `role_id`, `username`, `password`, `name`, `email`, `website`, `activation_key`, `image`, `bio`, `status`, `updated`, `updated_by`, `created`, `timezone`, `created_by`) VALUES
(1, 1, 'admin', 'a8a4f3978c9112326d9618cf05fa9cc3c387d736', 'admin', '', NULL, '8bf15d797415465ef7f67a6f1b13a526', NULL, NULL, 1, '2015-07-07 02:15:16', NULL, '2015-07-07 02:15:16', '0', NULL);
...
CREATE TABLE IF NOT EXISTS `web_vocabularies` (
  `id` int(10) NOT NULL AUTO_INCREMENT,
  `title` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `alias` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `description` text COLLATE utf8_unicode_ci,
