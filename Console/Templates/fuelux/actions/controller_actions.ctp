 ...
 */
 	public function <?php echo $admin ?>add() {
		...
		if ($this-><?php echo $currentModelName; ?>->save($this->request->data)) {
			$message = __d('<?php echo $underscoredPluginName; ?>','The <?php echo strtolower($singularHumanName); ?> has been saved');
			$result = 'success';
			...
			$message =__d('<?php echo $underscoredPluginName; ?>','The <?php echo strtolower($singularHumanName); ?> could not be saved. Please, try again.');
			$result = 'error';
		}
 ...
 */
	public function <?php echo $admin ?>delete() {
		...
		if ($this-><?php echo $currentModelName; ?>->delete($id)) {
			$message = __d('<?php echo $underscoredPluginName; ?>','Request deleted');
			$result = 'success';
		} else {
			$message = __d('<?php echo $underscoredPluginName; ?>','An error occured');
			$result = 'error';
		}
